...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row mb-3 align-items-center">
            <div class="col-md-6">
                <h4 class="page-title mb-0">Carpet Records for {{ $year }}-{{ sprintf('%02d', $month) }}</h4>
            </div>
            <div class="col-md-6 text-end">
                <!-- Filter Form -->
                <form method="GET" action="{{ route('reports.carpets.viewMonth') }}" class="d-inline-flex flex-wrap align-items-center justify-content-end">
        ...
        <!-- All Carpets Table -->
        <h5>All Carpets ({{ date('F Y', mktime(0, 0, 0, $month, 1, $year)) }})</h5>
